...
export default function AdminLayout() {
    ...
    return (
       <ModulesProvider>
            <div className="min-h-screen pl-[var(--sidebar-width)] max-lg:pl-0" aria-busy={isLoading}>
                ...
                <div className="min-w-0">
                    ...
                    <main className="min-w-0 flex-1">
                        <div className="page-container pb-8 pt-[30px] max-sm:!mx-[13px] sm:max-lg:!mx-5">{!isLoading && user ? <Outlet /> : null}</div>
                    </main>
                </div>
            </div>
       </ModulesProvider>
